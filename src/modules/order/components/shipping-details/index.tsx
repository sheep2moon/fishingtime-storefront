...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Dostawa</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Adres</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Metoda Dostawy</h3>
        <div>
